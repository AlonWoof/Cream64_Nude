...
const LevelScript level_wdw_entry[] = {
    ...
    AREA(/*index*/ 1, wdw_geo_000658),
        ...
        OBJECT_WITH_ACTS(/*model*/ MODEL_AMY_NUDE, /*pos*/  349, 3150,  -3760,  /*angle*/ 0, 0, 0, /*behParam*/ AMY_05 << 24, /*beh*/ bhvToadMessageAmy5,   /*acts*/ ACT_2 | ACT_3),
        ...
        OBJECT_WITH_ACTS(/*model*/ MODEL_GOOMBA_CREM, /*pos*/  -220,  3860,    60, /*angle*/ 0, 0, 0, /*behParam*/ 0x000C0000, /*beh*/ bhvGoombaCrem, ACT_3),
